...
?>
    <div class="container container--narrow page-section">
            ...
            <div class="row group">
                ...
                <div class="two-thirds">
                    ...
                    <span class="like-box" data-professor="<?php the_ID(); ?>" data-exists="<?php echo $existStatus; ?>">
                        ...
                        <!-- found_posts helps to return the number of posts matched the query -->
                    </span>
                    <?php the_content(); ?>
                </div>
            </div>
        ...
        <?php
        $relatedPrograms = get_field('related_programs'); //our ACF plugins gives access to this function
        if ($relatedPrograms) {
